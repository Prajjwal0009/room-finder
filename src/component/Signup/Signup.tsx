           ...
           <div className=' flex items-center justify-center w-full bg-gray-600 h-screen'>
                <div className='border border-black bg-red-100 w-[900px] '>
                    ...
                    <div className='grid grid-rows-5 grid-flow-col p-9'>
                        ...
                        <p className='text-xl flex justify-center items-center font-semibold mt-10'>Full Name:</p>
                        <p className='text-xl flex justify-center items-center font-semibold mt-10'>Email Address:</p>
                        <p className='text-xl flex justify-center items-center font-semibold mt-10'>Phone Number:</p>
                        <p className='text-xl flex justify-center items-center font-semibold mt-10'>Password:</p>
                        <p className='text-xl  flex justify-center items-center font-semibold mt-10'> Confirm Password:</p>
